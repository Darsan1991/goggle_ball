...
public class GameSettingsEditor : Editor
{
    ...
    private void FixMissingSymbols()
    {
        ...
        HandleScriptingSymbol(BuildTargetGroup.iOS, adsSettings.iosAdColonySettings.enable, "ADCLONY");
        HandleScriptingSymbol(BuildTargetGroup.Android, adsSettings.androidAdColonySettings.enable, "ADCLONY");
    ...
    private bool MissingSymbols()
    {
        ...
        if (adsSettings.androidAdColonySettings.enable && !HaveBuildSymbol(BuildTargetGroup.Android, "ADCLONY"))
        {
            return true;
        }
